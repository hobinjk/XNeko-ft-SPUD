...
export class Inventory {
  constructor(settings, actionManager) {
    ...
    this.openButton.innerHTML = openSvg;
    ...
    this.settingsButton.innerHTML = settingsSvg;
    ...
    templates.addOnChange((newTemplates) => {
      this.addPropTemplates(newTemplates);
    });
    this.addPropTemplates(templates.get());
  }
  ...
  addPropTemplates() {
    ...
    this.propTemplatesById = {};
    for (let propTemplate of templates.get()) {
  ...
  addPropTemplate(propTemplate) {
    ...
    propTemplateContainer.dataset.id = propTemplate.id;
    this.propTemplatesById[propTemplate.id] = propTemplate;
